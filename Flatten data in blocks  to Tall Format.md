# Flatten Hierarerchical Matrix to Tall Format

**Purpose**: Transform a cross-tabbed Excel matrix containing Area blocks, Branch groupings, and metric values into a flat, analysis-ready table.
